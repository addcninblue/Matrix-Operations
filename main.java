public class main {
    public static void main(String[] args) {
        ...
        int[][] inputMatrix = input.getUserMatrix(); //store's user's input as matrix
        int[] solutionsMatrix = input.getSolutionsMatrix(inputMatrix.length);
        int[][] testSubmatrix = det.Submatrix(inputMatrix, 2, 1); //testing Submatrix function
